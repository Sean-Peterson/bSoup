...
with open(filename, 'w') as csvfile:
    ...
    #lines 8 - 30 navigates to gsm arena and grabs all the manufacturers of devices
    ...
    for phone in phones:
        ...
        try:
            ...
            #     if int(price2[1])>=200:
            #         phonePrice = "High"
            #     elif int(price2[1])<200 and int(price2[1])>=100:
            #         phonePrice = "Medium"
            #     else:
            #         phonePrice = "low"
            # else:
            #     pass
            # currentPhone.append(phonePrice)
